...
public class DataHolder {
    ...
    private Map<String, Integer> stationReservations = new HashMap<String, Integer>();
    ...
    public int getReservedBikes(String station){
        if(this.stationReservations.containsKey(station))
            return this.stationReservations.get(station);
        else
            return 0;
    }

    public void setReservedBike(String station){
        if(this.stationReservations.keySet().contains(station)){
            this.stationReservations.put(station,this.stationReservations.get(station)+1);
        }
        else{
            this.stationReservations.put(station,1);
        }
    }

    public void dropReservedBike(String station){
        this.stationReservations.put(station,this.stationReservations.get(station)-1);
    }
